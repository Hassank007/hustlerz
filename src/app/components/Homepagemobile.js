...
const Homepagemobile = () => {
  return (
    <div className="sm:hidden">
      <div className="left w-full h-2/3 flex justify-center items-center  bg-[#231f20] ">
        <div className="flex items-start justify-start left">
          <img src="images9M.webp" className="w-full h-[49rem]" />
        </div>
      </div>
      <div className="right w-full h-[600px] flex  justify-center items-center  bg-[#231f20]">
        <div className="flex flex-col w-[53rem] pl-[1rem] right justify-start items-start  ">
          ...
          <h2 className="text-sm text-white py-5"> — Milan Kundera</h2>
        </div>
      </div>
      <div className="right w-full h-full flex justify-center items-center transition-transform duration-1000 bg-white">
        <div className="flex items-start justify-start right">
          <img src="marketM.jpg" className="w-full h-[48.3rem]" />
        </div>
      </div>
      <div className="left w-full h-full flex justify-center items-center  bg-white">
        ...
        <h2 className="text-base py-3 font-bold pcolor">                    — Michael Hyatt</h2>
    ...
    </div><div className="left w-full h-full flex justify-center items-center transition-transform duration-1000 bg-[#231f20]">
        <div className="flex items-start justify-start left">
          <img src="target.jpg" className="w-full h-[48.3rem]" />
        </div>
      </div><div className="right w-full h-full flex justify-center items-center transition-transform duration-1000 bg-[#231f20]">
      ...
      </div><div className="left w-full h-full flex justify-center items-center bg-white">
      ...
      </div><div className="flex items-start justify-start left">
        <img src="contactusM.jpg" className="w-full h-[48.3rem]" />
      </div>
    </div>
  );
};
